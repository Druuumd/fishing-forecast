...
Write-Host "Running ML retrain on $BaseUrl ..." -ForegroundColor Cyan
...
$result = Invoke-RestMethod -Uri "$BaseUrl/v1/admin/ml/retrain" -Method Post -TimeoutSec 30 -Headers $headers
