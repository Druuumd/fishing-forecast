...
Write-Host "Fetching active ML model from $BaseUrl ..." -ForegroundColor Cyan
...
$result = Invoke-RestMethod -Uri "$BaseUrl/v1/admin/ml/active" -Method Get -TimeoutSec 20 -Headers $headers
